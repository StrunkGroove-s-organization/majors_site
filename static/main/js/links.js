const exchangeInfo = {
   binance: {
      ...
      generateConvertLink(firstToken, secondToken) {
         ...
         return `https://www.binance.com/ru/trade/${firstToken}_${secondToken}?theme=dark&type=spot`
      }
   },
   huobi: {
      ...
      generateConvertLink(firstToken, secondToken) {
         return `${this.baseUrl}ru-ru/trade/${firstToken.toLowerCase()}_${secondToken.toLowerCase()}?type=spot`
      }
   },
   bybit: {
      ...
      generateConvertLink(firstToken, secondToken) {
         return `${this.baseUrl}ru-RU/trade/spot/${firstToken}/${secondToken}`
      }
   },
   okx: {
      ...
      generateConvertLink(firstToken, secondToken) {
         return `${this.baseUrl}ru/trade-spot/${firstToken}-${secondToken}`
      }
   },
   bitget: {
   ...
   kucoin: {
      ...
      generateConvertLink(firstToken, secondToken) {
         return `${this.baseUrl}ru/trade/${firstToken}-${secondToken}`
      }
   },
   'gate.io': {
