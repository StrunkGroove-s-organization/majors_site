        ...
        return fetch('/api/v1/links_without_cards_3/',
            {
                ...
                for (const key in data) {
                    ...
                    for (const key in item) {
                        ...
                        if ((limitFilterValue >= element.lim_min) && (limitFilterValue <= element.lim_max)) {
                            ...
                            row.innerHTML = `
                                ...
                                <div class="token-links__first-step">
                                    ...
                                    <div class="token-links__item-content">
                                        ...
                                        <a href="${exchangeInfo.binance.generateConvertLink(element.ad_give_first, element.ad_give_second.abbr)}" target="_blank" class="btn btn_purple btn_nocard">Купить</a>
                                    </div>
                                    </div>
                                    ...
                                    <div class="token-links__third-step">
                                        ...
                                        <div class="token-links__item-content">
                                            ...
                                            <a href="${exchangeInfo.binance.generateConvertLink(element.ad_get_first.abbr, element.ad_get_second)}" target="_blank" class="btn btn_purple btn_nocard btn_nocard_sell">Продать</a>
                                        </div>
                                    </div>
